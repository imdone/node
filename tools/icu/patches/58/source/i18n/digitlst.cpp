...
DigitList::setRoundingMode(DecimalFormat::ERoundingMode m) {
    ...
    switch (m) {
      ...
      default:
         // TODO: how to report the problem? id:4122
...
DigitList::getDouble() const
{
    ...
    if (isZero()) {
        ...
        if (getCount() > MAX_DBL_DIGITS + 3) {
            ...
            // TODO: how many extra digits should be included for an accurate conversion? id:4076
        } else {
...
int64_t DigitList::getInt64() /*const*/ {
    // TODO: fast conversion if fHave == fDouble id:3302
    ...
    // TODO: It would be faster to store a table of powers of ten to multiply by id:3631
...
DigitList::fitsIntoLong(UBool ignoreNegativeZero) /*const*/
{
    ...
    // TODO: Should cache these constants; construction is relatively costly. id:3802
...
DigitList::fitsIntoInt64(UBool ignoreNegativeZero) /*const*/
{
    ...
    // TODO: Should cache these constants; construction is relatively costly. id:4123
...
DigitList::set(double source)
{
    ...
    // TODO: Use something other than sprintf() here, since it's behavior is somewhat platform specific. id:4078
 ...
 *      TODO: probably should expand some, for rounding increments that id:3305
