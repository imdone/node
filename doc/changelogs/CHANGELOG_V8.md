...
<a id="8.7.0"></a>
## 2017-10-10, Version 8.7.0 (Current), @jasnell
...
* [[`64917acf23`](https://github.com/nodejs/node/commit/64917acf23)] - 2017-10-10, Node.js Version 8.7.0 (Current) (Myles Borins) 
* [[`b48ff2aa1e`](https://github.com/nodejs/node/commit/b48ff2aa1e)] - 2017-09-26, Node.js Version 8.6.0 (Current) (James M Snell) 
* [[`da7c87f6ec`](https://github.com/nodejs/node/commit/da7c87f6ec)] - **async_hooks**: fix reference in code comment (Brian White) [#15748](https://github.com/nodejs/node/pull/15748)
...
* [[`6a988c61b7`](https://github.com/nodejs/node/commit/6a988c61b7)] - **deps**: V8: cherry-pick 163d360 from upstream (Ali Ijaz Sheikh) [#15664](https://github.com/nodejs/node/pull/15664)
* [[`4587c3bc31`](https://github.com/nodejs/node/commit/4587c3bc31)] - **deps**: update npm to 5.4.2 (Michaël Zasso) 
...
* [[`c0b5b09381`](https://github.com/nodejs/node/commit/c0b5b09381)] - **(SEMVER-MAJOR)** **deps**: add postmortem metadata for V8 TurboFan (Michaël Zasso) [#14730](https://github.com/nodejs/node/pull/14730)
...
* [[`ede9d2ed8e`](https://github.com/nodejs/node/commit/ede9d2ed8e)] - **(SEMVER-MAJOR)** **deps**: cherry-pick f19b889 from upstream V8 (Michaël Zasso) [#14730](https://github.com/nodejs/node/pull/14730)
* [[`63ebad5a04`](https://github.com/nodejs/node/commit/63ebad5a04)] - **(SEMVER-MAJOR)** **deps**: fix addons compilation with VS2013 (Bartosz Sosnowski) [#13263](https://github.com/nodejs/node/pull/13263)
...
* [[`0870a80569`](https://github.com/nodejs/node/commit/0870a80569)] - **dgram**: refactor SO_RCVBUF and SO_SNDBUF methods (cjihrig) [#15483](https://github.com/nodejs/node/pull/15483)
* [[`cffdbbd06b`](https://github.com/nodejs/node/commit/cffdbbd06b)] - **(SEMVER-MINOR)** **dgram**: support for setting socket buffer size (Damien O'Reilly) [#13623](https://github.com/nodejs/node/pull/13623)
* [[`02f80be012`](https://github.com/nodejs/node/commit/02f80be012)] - **doc**: fix typo in tls.md (kohta ito) [#15738](https://github.com/nodejs/node/pull/15738)
* [[`af2427a305`](https://github.com/nodejs/node/commit/af2427a305)] - **doc**: add 'git clean -xfd' to backport guide (Lance Ball) [#15715](https://github.com/nodejs/node/pull/15715)
* [[`addcc8afa8`](https://github.com/nodejs/node/commit/addcc8afa8)] - **doc**: alphabetize TSC Emeriti in README.md (Rich Trott) [#15722](https://github.com/nodejs/node/pull/15722)
* [[`a44036d1bb`](https://github.com/nodejs/node/commit/a44036d1bb)] - **doc**: change encoding to decoding (Sakthipriyan Vairamani (thefourtheye)) [#15706](https://github.com/nodejs/node/pull/15706)
* [[`9381105143`](https://github.com/nodejs/node/commit/9381105143)] - **doc**: fix dead link in doc/releases.md (Luigi Pinca) [#15733](https://github.com/nodejs/node/pull/15733)
* [[`9ff55000f2`](https://github.com/nodejs/node/commit/9ff55000f2)] - **doc**: fix v8.6 changelog entry (Ruben Bridgewater) [#15716](https://github.com/nodejs/node/pull/15716)
* [[`11757cb311`](https://github.com/nodejs/node/commit/11757cb311)] - **doc**: add missing TOC entry in CONTRIBUTING.md (Vse Mozhet Byt) [#15729](https://github.com/nodejs/node/pull/15729)
* [[`7f56d24d53`](https://github.com/nodejs/node/commit/7f56d24d53)] - **doc**: update fs.utimes{,Sync} changelog (Luigi Pinca) [#15680](https://github.com/nodejs/node/pull/15680)
* [[`0aad7b15ce`](https://github.com/nodejs/node/commit/0aad7b15ce)] - **doc**: edit COLLABORATORS_GUIDE.md for readability (Rich Trott) [#15629](https://github.com/nodejs/node/pull/15629)
* [[`e58b82dc34`](https://github.com/nodejs/node/commit/e58b82dc34)] - **doc**: fix links in some intra-repository docs (Vse Mozhet Byt) [#15675](https://github.com/nodejs/node/pull/15675)
* [[`f1e4e02e8b`](https://github.com/nodejs/node/commit/f1e4e02e8b)] - **doc**: standardize function param/object prop style (Gibson Fahnestock) [#13769](https://github.com/nodejs/node/pull/13769)
* [[`d790fa147d`](https://github.com/nodejs/node/commit/d790fa147d)] - **doc**: do not begin yaml value with backtick (Jon Moss) [#15447](https://github.com/nodejs/node/pull/15447)
* [[`c2a790105e`](https://github.com/nodejs/node/commit/c2a790105e)] - **doc**: fix link in the test/README.md (Rimas Misevičius) [#15642](https://github.com/nodejs/node/pull/15642)
* [[`ab6b3ef4c3`](https://github.com/nodejs/node/commit/ab6b3ef4c3)] - **doc**: update libuv license (Timothy Gu) [#15649](https://github.com/nodejs/node/pull/15649)
...
* [[`a8020bf3a8`](https://github.com/nodejs/node/commit/a8020bf3a8)] - **http2**: making sending to the socket more efficient (James M Snell) [#15693](https://github.com/nodejs/node/pull/15693)
* [[`e5feb7d2de`](https://github.com/nodejs/node/commit/e5feb7d2de)] - **http2**: eliminate dead code (James M Snell) [#15693](https://github.com/nodejs/node/pull/15693)
* [[`420139fc56`](https://github.com/nodejs/node/commit/420139fc56)] - **http2**: refactor method arguments to avoid bools (James M Snell) [#15693](https://github.com/nodejs/node/pull/15693)
* [[`18dbcf256a`](https://github.com/nodejs/node/commit/18dbcf256a)] - **http2**: simplify TypeName (James M Snell) [#15693](https://github.com/nodejs/node/pull/15693)
* [[`c5db39e41a`](https://github.com/nodejs/node/commit/c5db39e41a)] - **http2**: setting shuttingDown=true after validation (Trivikram Kamat) [#15676](https://github.com/nodejs/node/pull/15676)
* [[`1856bebcfc`](https://github.com/nodejs/node/commit/1856bebcfc)] - **http2**: adjust error emit in core, add tests (Anatoli Papirovski) [#15586](https://github.com/nodejs/node/pull/15586)
* [[`6582dcb86e`](https://github.com/nodejs/node/commit/6582dcb86e)] - **n-api**: add check for large strings (Michael Dawson) [#15611](https://github.com/nodejs/node/pull/15611)
* [[`435d9d47ea`](https://github.com/nodejs/node/commit/435d9d47ea)] - **perf_hooks**: remove docs for unimplemented API (Sam Roberts) [#15641](https://github.com/nodejs/node/pull/15641)
* [[`e292d0978f`](https://github.com/nodejs/node/commit/e292d0978f)] - **src**: fix windows-only build breakage (Ben Noordhuis) [#15724](https://github.com/nodejs/node/pull/15724)
* [[`7b7e623994`](https://github.com/nodejs/node/commit/7b7e623994)] - **src**: remove unused includes in src/tracing (Daniel Bevenius) [#15682](https://github.com/nodejs/node/pull/15682)
* [[`d218f602f9`](https://github.com/nodejs/node/commit/d218f602f9)] - **src**: use UV_EINVAL instead of EINVAL in udp_wrap (Daniel Bevenius) [#15444](https://github.com/nodejs/node/pull/15444)
* [[`98fbaa956d`](https://github.com/nodejs/node/commit/98fbaa956d)] - **src**: fix compiler warning in udp_wrap.cc (Daniel Bevenius) [#15402](https://github.com/nodejs/node/pull/15402)
* [[`91afa7481e`](https://github.com/nodejs/node/commit/91afa7481e)] - **src**: remove unused using in node_trace_writer.h (Daniel Bevenius) [#15646](https://github.com/nodejs/node/pull/15646)
...
* [[`2e8652e164`](https://github.com/nodejs/node/commit/2e8652e164)] - **(SEMVER-MAJOR)** **src**: fix SmartOS compilation (Michaël Zasso) [#14730](https://github.com/nodejs/node/pull/14730)
...
* [[`9fbfa35d04`](https://github.com/nodejs/node/commit/9fbfa35d04)] - **stream**: fix disparity between buffer and the count (jlvivero) [#15661](https://github.com/nodejs/node/pull/15661)
* [[`1490f84059`](https://github.com/nodejs/node/commit/1490f84059)] - **stream**: fix todo (Ruben Bridgewater) [#15667](https://github.com/nodejs/node/pull/15667)
* [[`efa83f7350`](https://github.com/nodejs/node/commit/efa83f7350)] - **test**: increase test coverage for os.js (kuroljov) [#14098](https://github.com/nodejs/node/pull/14098)
* [[`a75f0424e6`](https://github.com/nodejs/node/commit/a75f0424e6)] - **test**: check that this != new.target in addon (Ben Noordhuis) [#15681](https://github.com/nodejs/node/pull/15681)
* [[`71897dec0d`](https://github.com/nodejs/node/commit/71897dec0d)] - **test**: Http2Stream destroy server before shutdown (Trivikram Kamat) [#15597](https://github.com/nodejs/node/pull/15597)
* [[`8e6f34f86b`](https://github.com/nodejs/node/commit/8e6f34f86b)] - **test**: make it easier to run tests for subsystems (Benjamin Coe) [#15450](https://github.com/nodejs/node/pull/15450)
* [[`1caaac11d4`](https://github.com/nodejs/node/commit/1caaac11d4)] - **test**: http2Stream redundant shutdown and single cb (Trivikram Kamat) [#15612](https://github.com/nodejs/node/pull/15612)
* [[`c59b0709cc`](https://github.com/nodejs/node/commit/c59b0709cc)] - **test**: update es-module.status prefix (Jack Horton) [#15690](https://github.com/nodejs/node/pull/15690)
* [[`fc1c5a0fa4`](https://github.com/nodejs/node/commit/fc1c5a0fa4)] - **test**: fix test-https-writable-true-after-close (Rich Trott) [#15705](https://github.com/nodejs/node/pull/15705)
...
* [[`2d578f9cae`](https://github.com/nodejs/node/commit/2d578f9cae)] - **timers**: warn on overflowed timeout duration (Jeremiah Senkpiel) [#15627](https://github.com/nodejs/node/pull/15627)
...
* [[`1f7c95622a`](https://github.com/nodejs/node/commit/1f7c95622a)] - **tty**: require readline at top of file (Bryan English) [#15647](https://github.com/nodejs/node/pull/15647)
* [[`bd91cf0b14`](https://github.com/nodejs/node/commit/bd91cf0b14)] - **url**: const-ify APIs, and pass URL by ref (Sam Roberts) [#15615](https://github.com/nodejs/node/pull/15615)
* [[`ac88cd530b`](https://github.com/nodejs/node/commit/ac88cd530b)] - **url**: fix remaining calculation (Rimas Misevičius) [#15637](https://github.com/nodejs/node/pull/15637)
...
* [[`97f7590c82`](https://github.com/nodejs/node/commit/97f7590c82)] - **(SEMVER-MINOR)** **util**: deprecate obj.inspect for custom inspection (Rich Trott) [#15631](https://github.com/nodejs/node/pull/15631)
