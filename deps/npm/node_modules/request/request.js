...
Request.prototype.init = function (options) {
  ...
  if (options.time) {
    ...
    // NOTE: elapsedTime is deprecated in favor of .timings id:880
...
Request.prototype.onRequestResponse = function (response) {
  ...
  response.on('end', function() {
    if (self.timing) {
      ...
      // NOTE: elapsedTime is deprecated in favor of .timings id:630
  ...
  // XXX This is different on 0.10, because SSL is strict by default id:587
  ...
  if (self._redirect.onResponse(response)) {
    ...
    responseContent.on('data', function (chunk) {
      if (self.timing && !self.responseStarted) {
        ...
        // NOTE: responseStartTime is deprecated in favor of .timings id:1078
