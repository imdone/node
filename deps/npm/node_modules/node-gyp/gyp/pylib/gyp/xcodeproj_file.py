...
class XCObject(object):
  ...
  def AppendProperty(self, key, value):
    # TODO (mark): Support ExtendProperty too (and make this call that)? id:823
  ...
  def VerifyHasRequiredProperties(self):
    ...
    # TODO (mark): A stronger verification mechanism is needed.  Some id:824
...
class XCHierarchicalElement(XCObject):
  ...
  # TODO (mark): Do name and path belong here?  Probably so. id:450
  ...
  def Hashables(self):
    ...
    # NOTE: This still has the problem that if an absolute path is encountered, id:528
  ...
  def CompareRootGroup(self, other):
    ...
    # listed order.
    # TODO (mark): "Build" is used by gyp.generator.xcode, perhaps the id:887
...
class PBXGroup(XCHierarchicalElement):
  ...
  def GetChildByName(self, name):
    ...
    #
    # TODO (mark): Maybe this should raise an error if more than one child is id:826
...
class PBXFileReference(XCFileLikeElement, XCContainerPortal, XCRemoteObject):
  ...
  def __init__(self, properties=None, id=None, parent=None):
    ...
    if 'path' in self._properties and \
      ...
      # TODO (mark): This is the replacement for a replacement for a quick hack. id:827
      ...
      if is_dir:
        ...
        # TODO (mark): Maybe it should try with the original case first and fall id:453
        # back to lowercase, in case there are any instances where case
        # matters.  There currently aren't.
        if ext != '':
          ext = ext[1:].lower()

        # TODO (mark): "text" is the default value, but "file" is appropriate id:531
...
class XCBuildConfiguration(XCObject):
  ...
  def SetBuildSetting(self, key, value):
    # TODO (mark): If a list, copy? id:890
...
class XCConfigurationList(XCObject):
  ...
  def GetBuildSetting(self, key):
    ...
    # TODO (mark): This is wrong for build settings that are lists.  The list id:829
...
class XCBuildPhase(XCObject):
  ...
  # TODO (mark): Some build phase types, like PBXShellScriptBuildPhase, don't id:831
...
class PBXCopyFilesBuildPhase(XCBuildPhase):
  ...
  path_tree_to_subfolder = {
    ...
    # TODO (mark): Map Xcode variable names to these. id:456
    # : 1,  # Wrapper
    # : 6,  # Executables: 6
    # : 7,  # Resources
    # : 15,  # Java Resources
...
class PBXNativeTarget(XCTarget):
  ...
  #
  # NOTE: Contrary to most objects, it is advisable to set parent when id:535
  ...
  def __init__(self, properties=None, id=None, parent=None,
    ...
    if 'productName' in self._properties and \
      ...
      if products_group != None:
        ...
        # TODO (tvl): Remove the below hack. id:893
...
class PBXProject(XCContainerPortal):
  ...
  def RootGroupForPath(self, path):
    ...
    # TODO (mark): make this a class variable and bind to self on call? id:835
    ...
    # TODO (mark): make additional choices based on file extension. id:833
  ...
  def _SetUpProductReferences(self, other_pbxproject, product_group,
                              project_ref):
    # TODO (mark): This only adds references to products in other_pbxproject id:458
    ...
    for target in other_pbxproject._properties['targets']:
      ...
      if product_group.GetChildByRemoteObject(other_fileref) is None:
        ...
        # TODO (mark): Does sourceTree get copied straight over from the other id:539
