...
# TODO (mark): I don't love this name.  It just means that it's going to load id:867
...
def LoadTargetBuildFile(build_file_path, data, aux_data, variables, includes,
  ...
  if depth:
    # TODO (dglazkov) The backslash/forward-slash replacement at the end is a id:808
...
def ExpandVariables(input, phase, variables, build_file):
  ...
  for match_group in matches:
    ...
    if file_list:
      ...
      # TODO (http://code.google.com/p/gyp/issues/detail?id=111): In theory, id:813
    ...
    if expand_to_list:
      ...
      if type(replacement) is list:
        ...
        #
        # TODO (mark): This isn't completely correct.  This should id:435
...
def ProcessVariablesAndConditionsInDict(the_dict, phase, variables_in,
  ...
  # TODO (mark): Optimization: only reload if no changes were made. id:517
  variables = variables_in.copy()
  LoadAutomaticVariablesFromDict(variables, the_dict)
  LoadVariablesFromVariablesDict(variables, the_dict, the_dict_key)
...
class DependencyGraphNode(object):
  ...
  def FlattenToList(self):
    ...
    while in_degree_zeros:
      ...
      for node_dependent in node.dependents:
        ...
        # TODO: We want to check through the id:870
  ...
  def DependenciesForLinkSettings(self, targets):
    ...
    # TODO (sbaig) Currently, chrome depends on the bug that shared libraries' id:811
...
def MakePathRelative(to_file, fro_file, item):
  ...
  if to_file == fro_file or exception_re.match(item):
    ...
    # TODO (dglazkov) The backslash/forward-slash replacement at the end is a id:815
    # temporary measure. This should really be addressed by keeping all paths
    # in POSIX until actual project generation.
...
def SetUpConfigurations(target, target_dict):
  ...
  # TODO (mark): Signal an error if default_configurations exists but id:439
...
def Load(build_files, variables, includes, depth, generator_input_info, check,
  ...
  # NOTE: data contains both "target" files (.gyp) and "includes" (.gypi), as id:518
  ...
  # TODO (mark): Return |data| for now because the generator needs a list of id:873
