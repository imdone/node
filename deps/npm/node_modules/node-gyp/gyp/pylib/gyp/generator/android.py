...
class AndroidMkWriter(object):
  ...
  def Write(self, qualified_target, relative_target, base_path, output_filename,
    ...
    # TODO: doesn't pull in things through transitive link deps; needed? id:393
  ...
  def WriteSourceFlags(self, spec, configs):
    ...
    # TODO: the source code should not use macro ANDROID to tell if it's host id:485
    # or target module.
    if self.toolset == 'host':
  ...
  def ComputeOutputParts(self, spec):
    ...
    """
    assert self.type != 'loadable_module' # TODO: not supported? id:721
  ...
  def ComputeOutput(self, spec):
    ...
    assert spec.get('product_dir') is None # TODO: not supported? id:785
  ...
  def WriteTarget(self, spec, configs, deps, link_deps, part_of_all,
    ...
    # NOTE: This has to come last! id:689
    modifier = ''
    if self.toolset == 'host':
      modifier = 'HOST_'
    if self.type == 'static_library':
...
def GenerateOutput(target_list, target_dicts, data, params):
  ...
  # TODO: search for the first non-'Default' target.  This can go id:396
