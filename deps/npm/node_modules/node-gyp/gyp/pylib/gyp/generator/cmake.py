...
def NormjoinPathForceCMakeSource(base_path, rel_path):
  ...
  if any([rel_path.startswith(var) for var in FULL_PATH_VARS]):
    return rel_path
  # TODO: do we need to check base_path for absolute variables as well? id:488
...
def WriteTarget(namer, qualified_target, target_dicts, build_dir, config_to_use,
  ...
  # TODO: It would be nice to be able to tell CMake all dependencies. id:726
  ...
  if target_type != 'none':
    ...
    if (not cflags_c or not c_sources) and (not cflags_cxx or not cxx_sources):
      ...
      # TODO: This is broken, one cannot generally set properties on files, id:787
...
def GenerateOutputForConfig(target_list, target_dicts, data,
  ...
  # TODO: Undocumented/unsupported (the CMake Java generator depends on it). id:693
