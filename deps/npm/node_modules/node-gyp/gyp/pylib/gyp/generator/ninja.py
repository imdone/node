...
class NinjaWriter(object):
  ...
  def WriteSpec(self, spec, config_name, generator_flags):
    ...
    actions_depends = []
    compile_depends = []
    # TODO (evan): it is rather confusing which things are lists and which id:505
  ...
  def WriteRules(self, rules, extra_sources, prebuild,
    ...
    for rule in rules:
      ...
      # TODO: if the command references the outputs directly, we should id:756
  ...
  def WriteLink(self, spec, config_name, config, link_deps):
    ...
    if self.flavor != 'mac' or len(self.archs) == 1:
      ...
      # TODO (yyanagisawa): more work needed to fix: id:800
  ...
  def WriteTarget(self, spec, config_name, config, link_deps, compile_deps):
    ...
    if spec['type'] == 'none' or (not link_deps and not extra_link_deps):
      # TODO (evan): don't call this function for 'none' target types, as id:716
      ...
      if (self.flavor not in ('mac', 'openbsd', 'netbsd', 'win') and not
        ...
        if self.flavor != 'mac' or len(self.archs) == 1:
          ...
          # TODO: It's not clear if libtool_flags should be passed to the alink id:422
          # call that combines single-arch .a files into a fat .a file.
          self.AppendPostbuildVariable(variables, spec,
                                       self.target.binary, self.target.binary)
          self.ninja.build(self.target.binary, 'alink', inputs,
                           # FIXME: test proving order_only=compile_deps isn't id:507
                           # needed.
                           variables=variables)
    else:
  ...
  def GetSortedXcodePostbuildEnv(self):
    ...
    # TODO (thakis): It would be nice to have some general mechanism instead. id:759
  ...
  def WriteNewNinjaRule(self, name, args, description, is_cygwin, env, pool,
    ...
    # TODO: we shouldn't need to qualify names; we do it because id:802
...
def GetDefaultConcurrentLinks():
  ...
  if sys.platform in ('win32', 'cygwin'):
    ...
    # TODO (scottmg): Implement this for other platforms. id:719
    return 1
...
def GenerateOutputForConfig(target_list, target_dicts, data, params,
  ...
  if flavor != 'win':
    ...
    # TODO (scottmg) Separate pdb names is a test to see if it works around id:424
  ...
  # interesting.
  # NOTE: there may be overlap between this an non_empty_target_names. id:511
  empty_target_names = set()

  # Set of non-empty short target names.
  # NOTE: there may be overlap between this an empty_target_names. id:762
