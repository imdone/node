...
class XcodeSettings(object):
  ...
  def _AppendPlatformVersionMinFlags(self, lst):
    ...
    if 'IPHONEOS_DEPLOYMENT_TARGET' in self._Settings():
      # TODO: Implement this better? id:819
  ...
  def GetCflags(self, configname, arch=None):
    ...
    if 'GCC_DYNAMIC_NO_PIC' in self._Settings():
      ...
      pass
      # TODO: In this case, it depends on the target. xcode passes id:445
    ...
    # TODO: This is exported correctly, but assigning to it is not supported. id:879
    ...
    if len(archs) != 1:
      # TODO: Supporting fat binaries will be annoying. id:820
  ...
  def GetCflagsCC(self, configname):
    ...
    for flag in self._Settings().get('OTHER_CPLUSPLUSFLAGS', ['$(inherited)']):
      # TODO: More general variable expansion. Missing in many other places too. id:822
  ...
  def _MapLinkerFlagFilename(self, ldflag, gyp_to_build_path):
    ...
    # TODO (thakis): Update ffmpeg.gyp): id:448
  ...
  def GetLdflags(self, configname, product_dir, gyp_to_build_path, arch=None):
    ...
    if arch is not None:
      ...
      archs = self.GetActiveArchs(self.configname)
    if len(archs) != 1:
      # TODO: Supporting fat binaries will be annoying. id:524
      self._WarnUnimplemented('ARCHS')
      archs = ['i386']
