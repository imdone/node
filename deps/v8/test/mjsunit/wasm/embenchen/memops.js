...
var Runtime = {
    ...
    type.flatIndexes = type.fields.map(function(field) {
      ...
      if (Runtime.isNumberType(field) || Runtime.isPointerType(field)) {
        ...
        if (field[1] === '0') {
          ...
          // and it adds no size
          // XXX this happens in java-nbody for example... assert(index === type.fields.length, 'zero-length in the middle!'); id:3496
          size = 0;
  ...
  UTF8Processor: function () {
    ...
    this.processJSString = function processJSString(string) {
      /* TODO: use TextEncoder when present, id:3951
...
// for 32-bit unsigned values or more than 32 bits. TODO: audit all uses of tempInt id:3811
...
function reSign(value, bits, ignore) {
  ...
  if (value >= half && (bits <= 32 || value > half)) { // for huge values, we can hit the precision limit and always get true here. so don't do that
                                                       ...
                                                       // TODO: In i64 mode 1, resign the two parts separately and safely id:3122
...
function copyTempDouble(ptr) {
  ...
  var MEMFS={ops_table:null,CONTENT_OWNING:1,CONTENT_FLEXIBLE:2,CONTENT_FIXED:3,mount:function (mount) {
        ...
        if (node.contentMode !== MEMFS.CONTENT_FLEXIBLE) {
          ...
          // NOTE: In our implementation, st_blocks = Math.ceil(st_size/st_blksize), id:3498
  ...
  var NODEFS={isWindows:false,staticInit:function () {
        ...
        if (flags in NODEFS.flagsToPermissionStringMap) {
          ...
          // FIXME this is terrible. id:3953
          ...
          // FIXME this is terrible. id:3813
  ...
  function _fflush(stream) {
      ...
      // we don't currently perform any user-space buffering of data
        ...
        if (!FS.FSNode) {
          ...
          // NOTE we must use Object.defineProperties instead of individual calls to id:2851
        ...
        // TODO if PROT is PROT_WRITE, make sure we have write access id:3126
        if ((stream.flags & 2097155) === 1) {
        ...
        // TODO deprecate the old functionality of a single id:3499
        ...
        LazyUint8Array.prototype.cacheLength = function LazyUint8Array_cacheLength() {
            ...
            var doXHR = (function(from, to) {
              ...
              // TODO: Use mozResponseArrayBuffer, responseStream, etc. if available. id:3955
              var xhr = new XMLHttpRequest();
              xhr.open('GET', url, false);
        ...
        Browser.init();
        // TODO we should allow people to just pass in a complete filename instead id:3815
  ...
  function _mkport() { throw 'TODO' }var SOCKFS={mount:function (mount) {
        ...
        return 'socket[' + (SOCKFS.nextname.current++) + ']';
          ...
          if (peer) {
            ...
            // TODO saddr and sport will be set for bind()'d UDP sockets, but what id:3500
  ...
  function __reallyNegative(x) {
      ...
      function getNextArg(type) {
        // NOTE: Explicitly ignoring type safety. Otherwise this fails: id:3817
        //       int x = 4; printf("%c\n", (char)x);
        var ret;
        if (type === 'double') {
      ...
      while(1) {
        ...
        if (curr == 37) {
          ...
          textIndex += 2;
          // TODO: Support a/A (hex float) and m (last error) specifiers. id:2857
          // TODO: Support %1${specifier} for arg selection. id:3134
        } else {
          ret.push(curr);
          textIndex += 1;
        }
  ...
  var Browser={mainLoop:{scheduler:null,method:"",shouldPause:false,paused:false,queue:[],pause:function () {
        ...
        audioPlugin['handle'] = function audioPlugin_handle(byteArray, name, onload, onerror) {
          ...
          if (Browser.hasBlobConstructor) {
            ...
            var url = Browser.URLObject.createObjectURL(b); // XXX we never revoke this! id:3501
            var audio = new Audio();
    ...
    // FIXME: ideally this should be clamped against the canvas size and zero id:3959
...
function exit(status) {
  ...
  // TODO We should handle this differently based on environment. id:3819
