...
// TODO (caitp): update kIterCount to a high enough number to trigger inlining, id:3710
...
var kTests = {
  ...
  Object: {
    PACKED_ELEMENTS() {
      ...
      // TODO (caitp): JSObjects always seem to start with HOLEY_ELEMENTS id:2735
    ...
    PACKED_SMI_ELEMENTS() {
      ...
      // TODO (caitp): JSObjects always seem to start with HOLEY_ELEMENTS id:2909
    ...
    HOLEY_SMI_ELEMENTS() {
      ...
      // TODO (caitp): JSObjects always seem to start with HOLEY_ELEMENTS id:3422
      // assertTrue(%HasSmiElements(object));
      // assertTrue(%HasHoleyElements(object));
    ...
    PACKED_DOUBLE_ELEMENTS() {
      ...
      // TODO (caitp): JSObjects always seem to start with HOLEY_ELEMENTS id:3869
    ...
    HOLEY_DOUBLE_ELEMENTS() {
      ...
      // TODO (caitp): JSObjects always seem to start with HOLEY_ELEMENTS id:3711
      // assertTrue(%HasDoubleElements(object));
      // assertTrue(%HasHoleyElements(object));
