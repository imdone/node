...
(function() {
  ...
  // log.push([geval(source).stack, "19:13"]);  TODO (4921). id:3424
})();

(function() {
  log.push([eval(source).stack, "23:13"]);
  log.push([eval(source).stack, "24:13"]);
  // log.push([eval(source).stack, "25:13"]);  TODO (4921). id:3870
})();

log.push([eval(source).stack, "28:11"]);
log.push([eval(source).stack, "29:11"]);
// log.push([eval(source).stack, "30:11"]);  TODO (4921). id:3712
