...
let tests = {
  FastElementsKind() {
    let runners = {
      ...
      // TODO (6587): Re-enable the below test case once we no longer deopt due id:2719
    ...
    let tests = {
      ...
      // TODO (6587): Re-enable the below test case once we no longer deopt due id:2861
      // to non-truncating uses of {CheckFloat64Hole} nodes.
