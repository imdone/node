...
var kTests = {
  ...
  Object: {
    PACKED_ELEMENTS() {
      ...
      // TODO (caitp): JSObjects always seem to start with HOLEY_ELEMENTS id:2783
    ...
    PACKED_SMI_ELEMENTS() {
      ...
      // TODO (caitp): JSObjects always seem to start with HOLEY_ELEMENTS id:3708
    ...
    HOLEY_SMI_ELEMENTS() {
      ...
      // TODO (caitp): JSObjects always seem to start with HOLEY_ELEMENTS id:3514
      // assertTrue(%HasSmiElements(object));
      // assertTrue(%HasHoleyElements(object));
    ...
    PACKED_DOUBLE_ELEMENTS() {
      ...
      // TODO (caitp): JSObjects always seem to start with HOLEY_ELEMENTS id:2473
    ...
    HOLEY_DOUBLE_ELEMENTS() {
      ...
      // TODO (caitp): JSObjects always seem to start with HOLEY_ELEMENTS id:2672
      // assertTrue(%HasDoubleElements(object));
      // assertTrue(%HasHoleyElements(object));
