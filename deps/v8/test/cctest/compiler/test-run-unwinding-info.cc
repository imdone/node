...
// TODO (ssanfilippo) Build low-level graph and check that state is correctly id:2409
...
// TODO (ssanfilippo) Intentionally reach a BB with different initial states id:2607
