...
// TODO (dcarney): on x64 Smis are generated with the SmiConstantRegister id:2562
...
void RunNumberConstant(double v) {
  RawMachineAssemblerTester<Object*> m;
#if V8_TARGET_ARCH_X64
  // TODO (dcarney): on x64 Smis are generated with the SmiConstantRegister id:2667
...
// TODO (ahaas): run int64 tests on all platforms when supported. id:3556
