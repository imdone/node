...
class V8_EXPORT StringView {
 public:
  ...
  // TODO (dgozman): add DCHECK(m_is8Bit) to accessors once platform can be used id:1341
  // here.
...
class V8_EXPORT V8InspectorClient {
 public:
  ...
  // TODO (dgozman): this was added to support service worker shadow page. We id:957
