...
template <class T> class PersistentBase {
 public:
   ...
   *  NOTE: There is no guarantee as to *when* or even *if* the callback is id:952
  ...
  // TODO (dcarney): remove this. id:1576
...
class NonCopyablePersistentTraits {
 public:
  ...
  // TODO (dcarney): come up with a good compile error here. id:1259
...
template <class T, class M> class Persistent : public PersistentBase<T> {
 public:
  ...
  // TODO (dcarney): this is pretty useless, fix or remove id:1345
  template <class S>
  ...
  // TODO (dcarney): this is pretty useless, fix or remove id:963
  template <class S>
...
class V8_EXPORT Module {
 public:
   ...
   * TODO (neis): Be more precise or say nothing. id:954
   */
...
class V8_EXPORT ScriptCompiler {
 public:
  ...
  struct V8_EXPORT CachedData {
    ...
    ~CachedData();
    // TODO (marja): Async compilation; add constructors which take a callback id:1579
...
class V8_EXPORT Message {
 public:
  ...
  // TODO (1245381): Print to a string instead of on a FILE. id:1263
...
class V8_EXPORT String : public Name {
 public:
  ...
  // TODO (dcarney): remove with deprecation of New functions. id:1375
  enum NewStringType {
 ...
 *
 * TODO (dcarney): Remove PROHIBITS_OVERWRITING as it is now unused. id:966
 */
enum AccessControl {
  DEFAULT               = 0,
  ALL_CAN_READ          = 1,
...
class V8_EXPORT Object : public Value {
 public:
   ...
   */
  // TODO (dcarney): take an isolate and optionally bail out? id:956
  Local<Object> Clone();
...
// TODO (mtrofin): rename WasmCompiledModule to WasmModuleObject, for id:1582
...
class V8_EXPORT WasmCompiledModule : public Object {
 ...
 private:
  // TODO (ahaas): please remove the friend once streamed compilation is id:1266
  // implemented
...
class V8_EXPORT WasmModuleObjectBuilder final {
 ...
 private:
  ...
  // TODO (ahaas): We probably need none of this below here once streamed id:1379
 ...
 public:
  ...
  class V8_EXPORT Allocator { // NOLINT
   public:
     ...
     */
    // TODO (eholk): make this pure virtual once blink implements this. id:970
     ...
     */
    // TODO (eholk): make this pure virtual once blink implements this. id:959
     ...
     * is committed.
     */
    // TODO (eholk): make this pure virtual once blink implements this. id:1585
...
class V8_EXPORT Template : public Data {
 public:
  ...
  void SetNativeDataProperty(
      ...
      AccessorSetterCallback setter = 0,
      // TODO (dcarney): gcc can't handle Local below id:1269
  ...
  void SetNativeDataProperty(
      ...
      AccessorNameSetterCallback setter = 0,
      // TODO (dcarney): gcc can't handle Local below id:1381
      Local<Value> data = Local<Value>(), PropertyAttribute attribute = None,
      Local<AccessorSignature> signature = Local<AccessorSignature>(),
      AccessControl settings = DEFAULT);
...
// TODO (dcarney): Deprecate and remove previous typedefs, and replace id:976
...
class V8_EXPORT ObjectTemplate : public Template {
 public:
   ...
   *   whenever they are invoked.
   */
  // TODO (dcarney): deprecate id:1588
