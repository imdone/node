...
class GenerateGnArgs(object):
  ...
  def cmd_gen(self):
    ...
    # TODO (machenbach): Check if the requested configurations has switched to id:2945
    # gn at all.
    ...
    # Append goma args.
    # TODO (machenbach): We currently can't remove existing goma args from the id:3181
  ...
  def main(self):
    ...
    # TODO (machenbach): Factor out common methods independent of mb arguments. id:3537
