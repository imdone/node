...
function NAMEConstructByIterable(obj, iterable, iteratorFn) {
  if (%IterableToListCanBeElided(iterable)) {
    ...
    // TODO (littledan): Computed properties don't work yet in nosnap. id:2295
...
function NAMEConstructByTypedArray(obj, typedArray) {
  // TODO (littledan): Throw on detached typedArray id:2313
  ...
  // TODO (littledan): Use the right prototype based on bufferConstructor's realm id:1947
...
// TODO (bmeurer): Migrate this to a proper builtin. id:3107
