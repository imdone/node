...
std::ostream& operator<<(std::ostream& os, const CallDescriptor& d) {
  // TODO (svenpanne) Output properties etc. and be less cryptic. id:1772
...
CallDescriptor* Linkage::ComputeIncoming(Zone* zone, CompilationInfo* info) {
  ...
  return nullptr;  // TODO (titzer): ? id:1339
}
...
bool Linkage::NeedsFrameStateInput(Runtime::FunctionId function) {
  switch (function) {
    ...
    case Runtime::kToFastProperties:  // TODO (conradw): Is it safe? id:2532
...
// TODO (all): Add support for return representations/locations to id:1813
// CallInterfaceDescriptor.
// TODO (turbofan): cache call descriptors for code stub calls. id:1934
