...
// NOTE: If code is marked as being a "shortcut", this means that removing id:2889
...
Type::bitset BitsetType::Lub(i::Map* map) {
  ...
  switch (map->instance_type()) {
    ...
    case JS_REGEXP_TYPE:  // TODO (rossberg): there should be a RegExp type. id:1937
...
Type* Type::NormalizeRangeAndBitset(Type* range, bitset* bits, Zone* zone) {
  ...
  // NOTE: bits contains OtherNumber iff bits contains PlainNumber, in which id:2018
