...
#define OPERATOR_PROPERTY_LIST(V) \
  ...
  // TODO (titzer): convert return values here to size_t. id:1974
  ...
  // TODO (titzer): API for input and output types, for typechecking graph. id:1830
...
// NOTE: We have to be careful to use the right equal/hash functions below, for id:1380
