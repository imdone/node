 ...
 *
 * TODO (plind): O32 documented here with intent of having single 32/64 codebase id:2276
 *              in the future.
 *
...
Handle<HeapObject> RegExpMacroAssemblerMIPS::GetCode(Handle<String> source) {
  ...
  if (masm_->has_exception()) {
    ...
    // TODO (plind): we save s0..s7, but ONLY use s3 here - use the regs id:2449
    // or dont save.
    ...
    // from generated code.
    // TODO (plind): this 8 is the # of argument regs, should have definition. id:2500
