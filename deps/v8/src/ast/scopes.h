...
class V8_EXPORT_PRIVATE Scope : public NON_EXPORTED_BASE(ZoneObject) {
 public:
  ...
  // TODO (verwaest): Is this needed on Scope? id:1750
  ...
  // names.
  // TODO (verwaest): Move to DeclarationScope? id:1374
...
class V8_EXPORT_PRIVATE DeclarationScope : public Scope {
 public:
  ...
  // TODO (wingo): Add a GLOBAL_SCOPE scope type which will lexically allocate id:1553
  ...
  // TODO (caitp): manage this state in a better way. PreParser must be able to id:1157
