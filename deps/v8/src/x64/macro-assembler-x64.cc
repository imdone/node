...
void TurboAssembler::CallRuntimeDelayed(Zone* zone, Runtime::FunctionId fid,
  ...
  // TODO (1236192): Most runtime routines don't need the number of id:2659
...
void MacroAssembler::CallRuntime(const Runtime::Function* f,
  ...
  // TODO (1236192): Most runtime routines don't need the number of id:3441
  // arguments passed in because it is constant. At some point we
  // should remove this need and make the runtime routine entry code
  // smarter.
...
void TurboAssembler::PrepareForTailCall(const ParameterCount& callee_args_count,
  ...
  if (callee_args_count.is_reg()) {
    ...
    // TODO (ishell): Unroll copying loop for small immediate values. id:2376
  }
