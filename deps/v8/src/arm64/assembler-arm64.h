...
struct Register : public CPURegister {
  ...
  //   - x27 (also context)
  //
  // TODO (all): Register x25 is currently free and could be available for id:1407
  // crankshaft, but we don't use it as we might use it as a per function
  // literal pool pointer in the future.
  //
  // TODO (all): Consider storing cp in x25 to have only two ranges. id:1037
...
class CPURegList {
 public:
  ...
  // TODO (all): Determine how we handle d8-d15 being callee-saved, but the top id:995
...
class Operand {
  // TODO (all): If necessary, study more in details which methods id:1626
  // TODO (all): should be inlined or not. id:1297
 public:
...
class Assembler : public AssemblerBase {
 public:
  ...
  // TODO (jbramley): Work out what sign to use for these things and if possible, id:1475
 ...
 private:
  ...
  void EmitData(void const * data, unsigned size) {
    ...
    // TODO (all): Somehow register we have some data here. Then we can id:1040
