...
void ProcessBacktrace(void* const* trace, size_t size,
  ...
  // NOTE: This code MUST be async-signal safe (it's used by in-process id:1763
...
void PrintToStderr(const char* output) {
  // NOTE: This code MUST be async-signal safe (it's used by in-process id:1408
  // stack dumping signal handler). NO malloc or stdio is allowed here.
...
void StackDumpSignalHandler(int signal, siginfo_t* info, void* void_context) {
  // NOTE: This code MUST be async-signal safe. id:1603
...
class PrintBacktraceOutputHandler : public BacktraceOutputHandler {
 public:
  ...
  void HandleOutput(const char* output) override {
    // NOTE: This code MUST be async-signal safe (it's used by in-process id:1236
    // stack dumping signal handler). NO malloc or stdio is allowed here.
...
StackTrace::StackTrace() {
  // NOTE: This code MUST be async-signal safe (it's used by in-process id:1074
  // stack dumping signal handler). NO malloc or stdio is allowed here.
...
void StackTrace::Print() const {
  // NOTE: This code MUST be async-signal safe (it's used by in-process id:1767
  // stack dumping signal handler). NO malloc or stdio is allowed here.
...
// NOTE: code from sandbox/linux/seccomp-bpf/demo.cc. id:1411
char* itoa_r(intptr_t i, char* buf, size_t sz, int base, size_t padding) {
