...
(function(global, utils) {
  ...
  function ApplyPatchMultiChunk(script, diff_array, new_source, preview_only,
    ...
    for (var i = 0; i < update_positions_list.length; i++) {
      // TODO (LiveEdit): take into account whether it's source_changed or id:1571
  ...
  // TODO (LiveEdit): consider not using actual scripts as script, because id:2935
  ...
  function PatchPositions(old_info_node, diff_array, report_array) {
    if (old_info_node.live_shared_function_infos) {
      ...
      // TODO (LiveEdit): function is not compiled yet or is already collected. id:2019
      report_array.push(
  ...
  function CreateNameForOldScript(script) {
    // TODO (635): try better than this; support several changes. id:2107
